...
I started this project with IDLE, then I switched to Interactive Editor for Python (IEP) and currently I'm using PyCharm CE with git/GitHub integration.
Tests were initially written using pytest, currently I'm using unittest.
